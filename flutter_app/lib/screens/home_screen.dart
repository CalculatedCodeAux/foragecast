...
class _HomeScreenState extends State<HomeScreen> {
  ...
  int _selectedWeekOffset = 1; // default: next week
  ...
  Future<void> _generateGuide() async {
    ...
    try {
      // For MVP, use hardcoded coords for known locations.
      // Real geocoding integration comes later.
      final guide = await _apiClient.predict(
        lat: 35.3, // placeholder, will be geocoded
        lng: -82.8,
        start: _weekStart,
        end: _weekEnd,
      );
            ...
            children: [
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: 'Search for a trailhead or area...',
              ...
              // Placeholder for saved guides (SQLite integration later)
              Container(
